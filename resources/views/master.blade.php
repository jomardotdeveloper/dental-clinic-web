...
<head>
    ...
    <title>Dental Clinic - @yield('title') </title>
    <!-- Favicon icon -->
									...
									<div class="header-info">
										...
										<small>
                                            ...
                                            @elseif (auth()->user()->contact->is_dentist)
                                                Dentist
                                            @elseif (auth()->user()->contact->is_staff)
                                                Staff
                                            @endif
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('contacts.index') }}?is_staff=1" class="ai-icon" aria-expanded="false">
                    ...
                    {{-- <li><a href="{{ route('schedules.index') }}" class="ai-icon" aria-expanded="false">
				...
				<div class="copyright">
					<p><strong>Dental Clinic Web System</strong> © 2023 All Rights Reserved</p>
