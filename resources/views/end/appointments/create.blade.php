...
<div class="row mb-5">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                @include('end.alert')
                <form action="{{ route('endappointments.store') }}" method="POST">
                    @csrf
                    ...
                    <input type="hidden" name="is_walk_in" value="{{ true }}" />
                    <div class="form-floating form-floating-outline mb-4">
                    ...
                    <div class="form-floating form-floating-outline mb-4">
                        <input class="form-control" type="text" placeholder="Consultation Hours" id="consultation_hours" name="consultation_hours" />
